    ...
    <>
      <div style={{ fontFamily: "'Poppins', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", background: '#f5f2ee', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{
          ...
          <Link href="/" style={{ color: '#2f3f58', textDecoration: 'none', fontWeight: 500 }}>Home</Link>
          <span style={{ color: '#d1d5db', margin: '0 0.5rem' }}>&gt;</span>
          <span style={{ color: '#618232', fontWeight: 600 }}>Classes</span>
        </div>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              fontWeight: 400,
              lineHeight: 1.7
            }}>Select a class to view students and their individual education plans.</p>
          </div>
          ...
          <div style={{ padding: '2.5rem 2rem', background: '#f5f2ee' }}>
            {loading ? (
              ...
              <div style={{
                ...
                <h3 style={{ fontSize: '1.25rem', fontWeight: 600, color: '#2f3f58', margin: '1rem 0 0.5rem' }}>No Classes Yet</h3>
                <p style={{ color: '#7a8492', marginBottom: '1.5rem' }}>Get started by creating your first class in the admin panel.</p>
                  ...
                  {classes.map((classItem) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p style={{ fontSize: '0.88rem', color: '#7a8492', margin: '0 0 1.25rem 0', lineHeight: 1.65, flexGrow: 1 }}>{classItem.description || 'No description'}</p>
                        ...
                        <p style={{ fontSize: '0.75rem', color: '#b8bec4', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.4px', marginTop: 'auto' }}>{classItem.ageRange || 'Age range not set'}</p>
                      </Link>
                    );
                  })}
                </div>
